    ...
    $.the7Slider = function (el, userSettings) {
        ...
        methods = {
            initVars: function () {
                ...
                $widget.css("--widget-height", $widget.height() + 'px');
            ...
            getThumbsPerView: function (device) {
                let slides_per_view = The7ElementorSettings.getResponsiveControlValue(settings, 'thumbs_per_view', 'size', device)
                return +slides_per_view || 1;
            },
            ...
            updateNav: function (slider) {
                if (methods.isEnoughtElements(slider.params.slidesPerView)) {
            ...
            isThumbsEnableLoop: function (slidesPerView) {
                let result = 'yes' === settings.thumbs_infinite;
                return result && methods.isEnoughtElements(slidesPerView);
            },
            ...
            playPauseVideo: function (slider, control) {
                ...
                currentSlide = slider.slides.eq(slider.activeIndex);
                playOnMobile = settings['play_on_mobile'] ? true : false;
