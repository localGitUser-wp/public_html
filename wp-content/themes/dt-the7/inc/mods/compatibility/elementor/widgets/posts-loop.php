...
class Posts_Loop extends The7_Elementor_Widget_Base {
	...
	protected function use_filter_request() {
		...
		return $settings['loading_mode'] === 'standard' || $settings['loading_mode'] === 'ajax_pagination' || ! empty( $settings['allow_filter_navigation_by_url'] );
	}
	 ...
	 */
	protected function get_query( $query_args = []) {
        $settings = $this->get_settings_for_display();
