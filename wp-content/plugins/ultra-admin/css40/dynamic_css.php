...
echo " \n/* -- Page BG -- */\n";
echo ultra_css_background("html,body, #wp-content-editor-tools, #ws_menu_editor .ws_editbox", "page-bg", "1.0") . "\n";
...
echo " \n/* -- link color -- */\n";
echo ultra_link_color("a, .no-plugin-results a,.row-actions span button.button-link", "link-color") . "\n";
...
$ultrastr = " .welcome-panel";
// echo ultra_css_background($ultrastr, "box-bg", "1.0") . "\n";
echo ultra_css_bgcolor($ultrastr, "primary-color", "1.0") . "\n";


echo " \n/* -- Box Head -- */\n";
$ultrastr = " .postbox .hndle, .stuffbox .hndle, 
...
$ultrastr = " .welcome-panel h2";
echo ultra_css_color($ultrastr, "#ffffff", "1.0","string") . "\n";
