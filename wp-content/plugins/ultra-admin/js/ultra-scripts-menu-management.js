...
jQuery(function($) {
    ...
    ULTRA_MENUMNG_SETTINGS.iconPanel = function(e) {
      ...
      $(document).on("click",".ultraicon",function(e) {
        e.stopPropagation();
    ...
    ULTRA_MENUMNG_SETTINGS.menuToggle = function() {
      ...
      $(document).on("click",".ultratoggle",function(e) {
      ...
      $(document).on("click",".ultrasubtoggle",function(e) {
    ...
    ULTRA_MENUMNG_SETTINGS.saveMenu = function() {
      ...
      $(document).on('click', '#ultra-savemenu', function(e){
    ...
    ULTRA_MENUMNG_SETTINGS.resetMenu = function() {
        ...
        $(document).on('click', '#ultra-resetmenu', function(e){
    ...
    ULTRA_MENUMNG_SETTINGS.menuDisplay = function() {
        ...
        $(document).on('click', '.ultradisplay, .ultrasubdisplay', function(e){
